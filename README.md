...
- Analytics & product projects: Practical projects that combine data analysis, user insights, product performance, and actionable recommendations.
- Case studies: Full case studies demonstrating research, usability testing, data-driven insights, and strategic thinking in product development.

🔎 **Focus areas:**
- Business & product performance: Leveraging Excel,, SQL, and Power BI to analyze key metrics and product performance. (Currently utilizing these tools for insights and performance tracking.)
- User behavior & insights: Conducting usability testing and user research to uncover user behavior patterns and inform customer-centric product decisions.
- Product strategy & thinking: Blending data analytics with product strategy to shape smarter product decisions and turn insights into actionable outcomes.
...
🎯 **Open to opportunities in:**
 - Business analytics
 - Product analytics
 - Product management (entry-level or associate roles)
